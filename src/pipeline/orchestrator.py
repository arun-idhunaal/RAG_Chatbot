...
from src.config.schemes import all_scheme_ids, list_canonical_names
...
from src.pipeline.models import Intent, PipelineResult, RetrievedChunk
...
def _handle_comparison(
    ...
    *,
    ...
    for scheme_id in scheme_ids:
        chunks = retriever.retrieve_scheme(text, scheme_id, fact_type=fact_type)
